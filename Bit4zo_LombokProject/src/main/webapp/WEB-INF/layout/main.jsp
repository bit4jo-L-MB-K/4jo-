                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6>Happy Birthday LOMBOK !!</h6>
                                <h2>이벤트 이벤트</h2>
                                <h2>이벤트 1111</h2>
                                <p>주저리 주저리 설명설명</p>
                                <a href="#" class="primary-btn">바아로가아기<span class="arrow_right"></span></a>
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="${root}/img/banner/banner-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="${root}/img/banner/banner-2.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
            ...
            <div class="row product__filter">
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-1.jpg">
                            <span class="label">New</span>
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-2.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-3.jpg">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-4.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-6.jpg">
                            <span class="label">Sale</span>
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-7.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="${root}/img/product/product-8.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="${root}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="${root}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="${root}/img/icon/search.png" alt=""></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="${root}/img/product-sale.png" alt="">
